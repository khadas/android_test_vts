...
_COMPONENTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIONIC_LIBM', index=23, number=1001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIONIC_LIBC', index=24, number=1002,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VNDK_LIBCUTILS', index=25, number=1101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SYSCALL', index=26, number=2001,
      options=None,
      type=None),
  ],
  containing_type=None,
