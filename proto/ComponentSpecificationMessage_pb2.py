...
_COMPONENTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIONIC_LIBM', index=27, number=1001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIONIC_LIBC', index=28, number=1002,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VNDK_LIBCUTILS', index=29, number=1101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SYSCALL', index=30, number=2001,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_VARIABLESPECIFICATIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fmq_id', full_name='android.vts.VariableSpecificationMessage.fmq_id', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fmq_desc_address', full_name='android.vts.VariableSpecificationMessage.fmq_desc_address', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ref_value', full_name='android.vts.VariableSpecificationMessage.ref_value', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hidl_memory_value', full_name='android.vts.VariableSpecificationMessage.hidl_memory_value', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='handle_value', full_name='android.vts.VariableSpecificationMessage.handle_value', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='predefined_type', full_name='android.vts.VariableSpecificationMessage.predefined_type', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='function_pointer', full_name='android.vts.VariableSpecificationMessage.function_pointer', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hidl_callback_type', full_name='android.vts.VariableSpecificationMessage.hidl_callback_type', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hidl_interface_id', full_name='android.vts.VariableSpecificationMessage.hidl_interface_id', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hidl_interface_pointer', full_name='android.vts.VariableSpecificationMessage.hidl_interface_pointer', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_input', full_name='android.vts.VariableSpecificationMessage.is_input', index=25,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_output', full_name='android.vts.VariableSpecificationMessage.is_output', index=26,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_const', full_name='android.vts.VariableSpecificationMessage.is_const', index=27,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_callback', full_name='android.vts.VariableSpecificationMessage.is_callback', index=28,
