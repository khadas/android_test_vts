...
_COMPONENTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIONIC_LIBM', index=24, number=1001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIONIC_LIBC', index=25, number=1002,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VNDK_LIBCUTILS', index=26, number=1101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SYSCALL', index=27, number=2001,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_VARIABLESPECIFICATIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='predefined_type', full_name='android.vts.VariableSpecificationMessage.predefined_type', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='function_pointer', full_name='android.vts.VariableSpecificationMessage.function_pointer', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hidl_callback_type', full_name='android.vts.VariableSpecificationMessage.hidl_callback_type', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_input', full_name='android.vts.VariableSpecificationMessage.is_input', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_output', full_name='android.vts.VariableSpecificationMessage.is_output', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_const', full_name='android.vts.VariableSpecificationMessage.is_const', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_callback', full_name='android.vts.VariableSpecificationMessage.is_callback', index=21,
