...
_COMPONENTSPECIFICATIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attribute', full_name='android.vts.ComponentSpecificationMessage.attribute', index=9,
...
_COMPONENTSPECIFICATIONMESSAGE.fields_by_name['attribute'].message_type = InterfaceSpecificationMessage_pb2._VARIABLESPECIFICATIONMESSAGE
