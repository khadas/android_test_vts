...
# source: test/vts/proto/AndroidSystemControlMessage.proto
...
_COMMANDTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VTS_AGENT_COMMAND_EXECUTE_SHELL_COMMAND', index=7, number=301,
      options=None,
      type=None),
  ],
...
_ANDROIDSYSTEMCALLBACKREQUESTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='arg', full_name='android.vts.AndroidSystemCallbackRequestMessage.arg', index=1,
...
_ANDROIDSYSTEMCALLBACKREQUESTMESSAGE.fields_by_name['arg'].message_type = vts.proto.InterfaceSpecificationMessage_pb2._VARIABLESPECIFICATIONMESSAGE
...
AndroidSystemControlCommandMessage = _reflection.GeneratedProtocolMessageType('AndroidSystemControlCommandMessage', (_message.Message,), dict(
  ...
  __module__ = 'vts.proto.AndroidSystemControlMessage_pb2'
