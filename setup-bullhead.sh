...
adb push images/bullhead/libvts_codecoverage32.so /data/local/tmp/lib/libvts_codecoverage.so
adb push images/bullhead/libvts_codecoverage.so /data/local/tmp/libvts_codecoverage.so
# hal
