...
# PYTHONPATH=$PYTHONPATH:.. python -m vts.testcases.hal.nfc.V1_0.host.NfcHidlBasicTest
# PYTHONPATH=$PYTHONPATH:.. python -m vts.testcases.hal.vibrator.V1_0.host.VibratorHidlTest
# PYTHONPATH=$PYTHONPATH:.. python -m vts.testcases.hal.automotive.vehicle.V2_0.host.VehicleHidlTest
# PYTHONPATH=$PYTHONPATH:.. python -m vts.testcases.hal.vr.V1_0.hidl.host.VrHidlTest
# PYTHONPATH=$PYTHONPATH:.. python -m vts.testcases.hal.tv.cec.V1_0.host.TvCecHidlTest
